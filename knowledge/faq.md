# Preguntas Frecuentes — Klank

<!-- Formato para cada entrada: -->
<!-- **Pregunta:** ¿...? -->
<!-- **Respuesta:** ... -->
<!-- (dejar una línea en blanco entre entradas) -->

**Pregunta:** ¿Tienen local físico o son solo online?
**Respuesta:** <!-- COMPLETAR -->
...
**Pregunta:** ¿Puedo encargar un producto que no tienen en stock?
**Respuesta:** <!-- COMPLETAR -->

**Pregunta:** ¿Hacen factura?
**Respuesta:** <!-- COMPLETAR: factura A, B, ticket, etc. -->

<!-- Agregá más preguntas frecuentes de tu negocio acá -->
